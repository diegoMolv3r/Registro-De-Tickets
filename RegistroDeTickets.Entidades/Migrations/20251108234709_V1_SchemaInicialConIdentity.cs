...
{
    /// <inheritdoc />
    public partial class V1_SchemaInicialConIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TokenHashRecuperacion = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    TokenHashRecuperacionExpiracion = table.Column<DateTime>(type: "DATETIME2", nullable: true),
